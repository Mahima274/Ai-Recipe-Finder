...
from recipe.models.user import User  # Import the User model
from recipe.models.feedback import Feedback  # Import the Feedback model
import subprocess
...
from recipe.models import db, User, Recipe  
from recipe.models.recipes_data import default_recipes
...
from recipe.config import SQLALCHEMY_DATABASE_URI
